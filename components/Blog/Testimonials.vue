...
<template>
  ...
  >
    <div class="flex lg:items-center justify-between w-full">
      <div class="">
        <p class="font-semibold text-primary text-lg uppercase">comments</p>
        <h2
          class="font-bold uppercase leading-snug text-2xl md:text-3xl text-black w-full max-w-[497px]"
        >

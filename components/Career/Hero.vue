...
<template>
  <div class="bg-blue py-20 pb-12 md:py-28 w-full">
    ...
    >
      <div class="">
        <p
          class="text-secondary text-sm md:text-2xl font-medium tracking-[1.92px]"
        >
        ...
        <p
          class="text-xl text-white leading-[30px] mx-auto w-full max-w-[768px]"
        >
          You think you can fit into a team of professionals having the interest
          of people? Watch this space for openings available in our world
        </p>
      </div>
    </div>
  </div>

...
const downloadHandout = async () => {
  const href = "https://s3.eu-west-2.amazonaws.com/files.tgpcmedia/pdfs/Meeting+Minutes+and+Agenda+Template+-+MEQC.docx"
...
<template>
  <div class="parent flex justify-center items-center">
    ...
    >
      <Icon
        @click="dialogStore.showEmailModal = false"
      ...
      <div class="flex flex-col text-center">
        <div class="flex justify-between items-stretch text-whiter">
          <img class="md:w-[503px] md:block hidden" src="/img/agenda.png" alt="agenda image" />
          <div
          ...
          >
            ...
            <h3
              class="font-semibold text-[24px] leading-[32px] tracking-[0.25px] text-whiter max-w-[459px]"
            >
              Get Your Free 12 Months Meeting Agenda and Minute Template Here
            </h3>

<template>
  <main>
    ...
    <div class="md:h-screen flex items-center justify-center header pt-32">
      <img :src="articleData.cover.Location" :alt="articleData.name"
    ...
    <div class="pt-5 pb-32 md:max-w-4xl md:mx-auto md:px-0 px-5 space-y-10">
      <h3 class="sans font-bold md:text-5xl text-2xl">{{ articleData.name }}</h3>
      <div class="text-lg">
